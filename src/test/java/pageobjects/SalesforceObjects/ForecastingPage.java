...
public class ForecastingPage {
    ...
    public static By selectAnObject = By.xpath("//*[@aria-label=\"Select an object... - Current Selection: Select an object...\"]");
    public static By selectAnObjectOpportunity = By.xpath("//span[text()=\"Opportunity\"]");
    public static By nextButton = By.xpath("//*[text()=\"Next\"]");
    public static By measurePage = By.xpath("//*[text()=\"Specify a measure\"]");
    public static By selectMeasure = By.xpath("//*[@aria-label=\"Select a measure... - Current Selection: Select a measure...\"]");
    public static By selectMeasureAmount = By.xpath("//span[text()=\"Amount\"]");
